            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{URL::to('/edit-product/'.$product->product_id)}}" class="active btn btn-primary " ui-toggle-class="">Sửa</a>
                        </td>
                        <td>
                            <a onclick="return confirm('Bạn muốn xóa không?')" href="{{URL::to('/delete-product/'.$product->product_id)}}" class="active btn btn-danger" ui-toggle-class="">Xóa</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
