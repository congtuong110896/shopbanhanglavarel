...
<div class="product-details"><!--product-details-->
    ...
    <img src="{{URL::to('public/upload/product/'.$values->product_image)}}" alt="" />
            <h3>ZOOM</h3>
        </div>
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <p>Mã ID: {{$values->product_id}}</p>
            <img src="public/frontend/images/product-details/rating.png" alt="" />
            <form action="{{URL::to("/save-cart")}}" method="POST">
                {{@csrf_field()}}
                <span>
                    <span>{{number_format($values->product_price)}}</span>
                    <label>Số lượng:</label>
                    <input name="qty" type="number" min="1" value="1" />
                    <input name="productid_hidden" type="hidden" value="{{$values->product_id}}" />
